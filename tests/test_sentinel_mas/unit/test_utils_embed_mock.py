...
def patch_sentence_transformer(monkeypatch) -> Generator[Any, Any, Any]:
...
def test_to_unit_vec_normalization() -> None:
...
def test_to_unit_vec_zero_norm_raises() -> None:
    from sentinel_mas.utils import to_unit_vec
...
def test_embed_text_unit(monkeypatch) -> None:
