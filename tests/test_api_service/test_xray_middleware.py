...
class TestXRayEnabled:
    ...
    @patch('aws_xray_sdk.core.xray_recorder')
    @patch('aws_xray_sdk.core.patch_all')
    def test_xray_segment_created_with_service_name(self, mock_patch_all, mock_recorder):
    ...
    def test_xray_captures_response_status(self, mock_patch_all, mock_recorder):
        ...
        with patch.dict(os.environ, {
            ...
            status_calls = [call for call in mock_segment.put_http_meta.call_args_list 
                          if call[0][0] == 'status']
