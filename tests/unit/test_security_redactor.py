...
class TestSecurityRedactor:
    ...
    def test_redactor_loading(self, sample_redactor_policy_file):
    ...
    def test_sensitive_keys_redaction(self, sample_redactor_policy_file):
    ...
    def test_nested_structure_redaction(self, sample_redactor_policy_file):
    ...
    def test_max_depth_respected(self, sample_redactor_policy_file):
    ...
    def test_string_truncation(self, sample_redactor_policy_file):
