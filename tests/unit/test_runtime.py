# test_runtime.py
import pytest
from sentinel_mas.policy_sentinel.runtime import SentinelContext, context_scope, get_context, get_graph_state, graph_state_scope
...
class TestRuntime:
    ...
    def test_graph_state_scope(self):
