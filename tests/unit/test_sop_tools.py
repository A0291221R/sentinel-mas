# sentinel_mas/tools/tests/test_sop_tools.py
import pytest
from unittest.mock import Mock, call
from sentinel_mas.tools.sop_tools import search_sop, get_sop

class TestSOPTools:
    
    def test_search_sop_success(self, mock_db_connection, mock_embedding):
    ...
    def test_search_sop_default_k(self, mock_db_connection, mock_embedding):
    ...
    def test_search_sop_custom_k(self, mock_db_connection, mock_embedding):
    ...
    def test_get_sop_by_id_success(self, mock_db_connection):
        """Test get_sop with valid SOP ID"""
        mock_connect, mock_conn, mock_cursor = mock_db_connection
        
        mock_cursor.fetchone.return_value = (
            'SOP-1', '1.1', 'Test Procedure', 'Detailed text...', 
            '["emergency", "safety"]', '2023-01-01 12:00:00', None
        )
        
        result = get_sop.invoke({
            "id_or_section": "SOP-1"
        })
    ...
    def test_get_sop_by_section_success(self, mock_db_connection):
        """Test get_sop with valid section number"""
        mock_connect, mock_conn, mock_cursor = mock_db_connection
        
        mock_cursor.fetchone.return_value = (
            'SOP-2', '2.3', 'Another Procedure', 'More text...', 
            None, '2023-01-01 12:00:00', None
        )
    ...
    def test_get_sop_not_found(self, mock_db_connection):
        """Test get_sop with non-existent ID/section"""
        mock_connect, mock_conn, mock_cursor = mock_db_connection
        mock_cursor.fetchone.return_value = None
        
        result = get_sop.invoke({
            "id_or_section": "NON_EXISTENT"
        })
    ...
    def test_search_sop_database_error(self, mock_db_connection, mock_embedding):
    ...
    def test_get_sop_database_error(self, mock_db_connection):
