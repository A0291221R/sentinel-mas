...
class TestInjectionGuard:
    ...
    def test_injection_guard_loading(self, sample_injection_policy_file: str) -> None:
    ...
    def test_clean_message_allowed(self, sample_injection_policy_file: str) -> None:
    ...
    def test_block_phrases_detection(self, sample_injection_policy_file: str) -> None:
    ...
    def test_mass_scope_detection(self, sample_injection_policy_file: str) -> None:
    ...
    def test_batch_targets_check(self, sample_injection_policy_file: str) -> None:
    ...
    def test_batch_targets_within_limit(
        self, sample_injection_policy_file: str
    ) -> None:
        ...
        allowed, reason = guard.scan_single(
            user_msg="Track these people",
            tool_name="send_track",
            tool_args={"resolved_ids": ["id1", "id2"]},  # 2 <= max_batch_targets(3)
        )

        assert allowed is True

    def test_non_tracking_tool_ignores_batch_check(
        self, sample_injection_policy_file: str
    ) -> None:
