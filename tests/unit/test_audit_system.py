...
from sentinel_mas.policy_sentinel.audit import (
    AuditEvent, build_audit_event, guard_deny_and_raise,
    audit_guard_allow, audit_tool_success, audit_tool_failure
)
...
class TestAuditSystem:
    ...
    def test_guard_deny_and_raise(self, mock_record_audit, mock_get_state, mock_get_context):
    ...
    @patch('sentinel_mas.policy_sentinel.audit.runtime.get_graph_state')
    @patch('sentinel_mas.policy_sentinel.audit.record_audit')
    def test_audit_guard_allow(self, mock_record_audit, mock_get_state, mock_get_context):
    ...
    @patch('sentinel_mas.policy_sentinel.audit.runtime.get_graph_state')
    @patch('sentinel_mas.policy_sentinel.audit.record_audit')
    def test_audit_tool_success(self, mock_record_audit, mock_get_state, mock_get_context):
    ...
    @patch('sentinel_mas.policy_sentinel.audit.runtime.get_graph_state')
    @patch('sentinel_mas.policy_sentinel.audit.record_audit')
    def test_audit_tool_failure(self, mock_record_audit, mock_get_state, mock_get_context):
