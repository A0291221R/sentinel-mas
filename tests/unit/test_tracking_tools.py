# sentinel_mas/tools/tests/test_tracking_tools.py
import os
import pytest
...
class TestTrackingTools:
    ...
    def test_send_track_success(self, mock_http_client):
        ...
        result = send_track.invoke({
            "resolved_id": "person_123"
        })
    ...
    def test_send_track_missing_resolved_id(self):
    ...
    def test_send_track_http_error(self, mock_http_client):
    ...
    def test_send_cancel_success(self, mock_http_client):
    ...
    def test_send_cancel_missing_resolved_id(self):
    ...
    def test_get_track_status_success(self, mock_http_client):
        ...
        result = get_track_status.invoke({
            "resolved_id": "person_123"
        })
        ...
        assert call_args[0][1] == "http://test-central:8000/person/person_123/tracking"  # URL
        
        assert result["ok"] is True
        assert result["data"]["is_tracked"] is True
    
    def test_get_track_status_missing_resolved_id(self):
    ...
    def test_get_person_insight_success(self, mock_http_client):
        ...
        result = get_person_insight.invoke({
            "resolved_id": "person_123"
        })
    ...
    def test_get_person_insight_missing_resolved_id(self):
    ...
    def test_connection_error_retry(self, mock_http_client):
    ...
    def test_all_retries_fail(self, mock_http_client):
