...
from sentinel_mas.policy_sentinel.secure_executor import secure_execute_tool, guard_tool_call, call_tool_safely

class TestSecureExecutor:

    def test_call_tool_safely_invoke(self):
    ...
    def test_call_tool_safely_run(self):
    ...
    def test_call_tool_safely_callable(self):
    ...
    def test_guard_tool_call_success(self, mock_rbac, mock_guard, mock_get_state, mock_get_context):
        ...
        mock_rbac.is_allowed.assert_called_once_with("operator", "TRACKING", "test_tool")
    ...
    def test_guard_tool_call_rbac_deny(
        ...
        mock_guard.scan_single.return_value = (True, "clean")
        # Mock RBAC to deny
        mock_rbac.is_allowed.return_value = (False, "Tool 'test_tool' not allowed for role 'operator'")
