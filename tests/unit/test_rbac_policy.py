...
class TestRBACPolicy:
    ...
    def test_rbac_loader_valid_policy(self, sample_rbac_policy_file: str) -> None:
    ...
    def test_rbac_is_allowed_success(self, sample_rbac_policy_file: str) -> None:
    ...
    def test_rbac_is_allowed_denied_role(self, sample_rbac_policy_file: str) -> None:
        """Test permission denied for unknown role"""
        policy = RBACPolicy(sample_rbac_policy_file)

        allowed, reason = policy.is_allowed(
            "unknown_role", "TRACKING", "who_entered_zone"
        )
        assert allowed is False
        assert "Unknown role" in reason

    def test_rbac_is_allowed_denied_route(self, sample_rbac_policy_file: str) -> None:
    ...
    def test_rbac_is_allowed_denied_tool(self, sample_rbac_policy_file: str) -> None:
    ...
    def test_get_allowed_tools(self, sample_rbac_policy_file: str) -> None:
    ...
    def test_get_roles(self, sample_rbac_policy_file: str) -> None:
    ...
    def test_describe_role(self, sample_rbac_policy_file: str) -> None:
    ...
    def test_assert_allowed_success(self, sample_rbac_policy_file: str) -> None:
    ...
    def test_assert_allowed_raises(self, sample_rbac_policy_file: str) -> None:
