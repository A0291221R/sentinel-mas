...
from sentinel_mas.policy_sentinel.runtime import SentinelContext, set_graph_state, get_graph_state
...
def mock_secure_execute():
    ...
    with patch('sentinel_mas.policy_sentinel.secure_executor.secure_execute_tool') as mock:
        yield mock
